...
public class DateFormatter {
    ...
    public static String getMessageTime(Context context, long date, String datetime) {
        String time = ", " + accountFor24HourTime(context, new SimpleDateFormat("h:mm a")).format(date);
        if (isSameDay(date)) {
    ...
    public static String getRecentMessageTime(Context context, long date, String datetime) {
        String time = ", " + accountFor24HourTime(context, new SimpleDateFormat("h:mm a")).format(date);
        if (isSameDay(date)) {
            return accountFor24HourTime(context, new SimpleDateFormat("h:mm a")).format(date);
        } else if (isYesterday(date)) {
